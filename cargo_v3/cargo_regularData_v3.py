...
proc = subprocess.Popen("sudo python /home/pi/gpstracker/cargo_v3/ser.py", stdout = subprocess.PIPE, shell = True)

de_number = "cargo_proto0"
rdata_path = "/home/pi/gpstracker/cargo_v3/Rdata.txt"
...
while True :
    ...
    while len(l) > 1 :
        ...
        rdata = {'de_number' : line[0], 'tra_temp' : line[1], 'tra_humidity' : line[2], 'tra_Gx' : line[3], 'tra_Gy' : line[4], 'tra_Gz' : line[5], 'tra_Ax' : line[6], 'tra_Ay' : line[7], 'tra_Az' : line[8], 'tra_datetime' : line[9], 'tra_lat' : line[10], 'tra_lon' : line[11], 'tra_impact' : line[12]}
        try : 
            res = requests.post(url = d_url, data = rdata)
